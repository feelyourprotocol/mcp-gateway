...
export function readEngineLabInput<T = SimulateBytecodeInput>(shape: string, exampleId: string): T {
  const filePath = path.join(engineLabRoot, 'shapes', shape, 'examples', exampleId, 'input.json')
