...
export const DESCRIBE_CAPABILITIES_DESCRIPTION = [
  ...
  'EIP twins (8024, 7843, 7708, 7928 BAL, 8037, 8038 on Amsterdam; 7702 set-code on Prague; 7883 ModExp and 7951 P-256 on Osaka).',
...
export const RUN_TRANSACTION_DESCRIPTION = [
  ...
  'Optional authorizationList (Prague+) runs an EIP-7702 set-code type-4 tx — sponsor from, to = authority EOA, delegate code in accounts[].',
