...
export const DESCRIBE_CAPABILITIES_DESCRIPTION = [
  ...
  'Live coverage: EIP-8024 opcodes via run_bytecode; EIP-7843 SLOTNUM via run_block;',
  ...
  'Then use run_bytecode for opcodes/precompiles, run_transaction for a single paid tx,',
  'or run_block for 1–8 txs as one lab block (optional header slot/number/timestamp).',
...
export const RUN_TRANSACTION_DESCRIPTION = [
  ...
  'Use when the question is a wallet gasLimit, first-touch transfer, paid tx gas, receipt logs, or txStateGas (EIP-8037 / new-slot SSTORE).',
...
export const RUN_BLOCK_DESCRIPTION = [
  ...
  'Use when the question needs a header slot (EIP-7843 SLOTNUM), several txs in one block, or a header timestamp/number.',
