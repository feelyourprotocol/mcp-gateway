...
export const SERVER_INSTRUCTIONS = [
  ...
  'under a named fork from Berlin through Amsterdam (default preview; alias Glamsterdam),',
  'even if they do not name an EIP.',
  'Call describe_capabilities first: namedForks is the Berlin→Amsterdam lineage (order, predecessorId,',
